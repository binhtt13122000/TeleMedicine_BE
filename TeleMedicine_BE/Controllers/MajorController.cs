...
namespace TeleMedicine_BE.Controllers
{
    ...
    public class MajorController : Controller
    {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(filters))
                {
                    ...
                    if (checkHasProperty)
                    {
                        ...
                        string json = jsonIgnore.JsonIgnore(typeof(MajorVM), splitFilter, paged, PropertyRenameAndIgnoreSerializerContractResolver.IgnoreMode.EXCEPT);
        ...
        /// Create a new major
        /// </summary>
        /// <response code="201">Created new major successfull</response>
